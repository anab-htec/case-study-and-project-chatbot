...
dataset = [
    Golden(
        ...
        additional_metadata={"scenario": "case_study_sum"}
    ),
    Golden(
    ...
    #     additional_metadata={"scenario": "project_match"}
    # ),
    # Golden(
    ...
    #      additional_metadata={"scenario": "no_results"}
    # ),
    # Golden(
    ...
    #     additional_metadata={"scenario": "ambiguous_intent"}
    # ),
    # Golden(
